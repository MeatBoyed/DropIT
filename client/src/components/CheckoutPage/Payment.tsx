...
export const Payment: React.FC<Props> = ({ onChange }) => {
    ...
    <React.Fragment>
      <section id="PaymentSection">
        <div className="orderSummaryContainer">
          ...
          <InformationCard
            cardTitle="Ship To"
            cardText="12 Thomis Morris st, Walivs Bay, P.O BOX 1595"
            changeOption={true}
          />
        ...
        <div className="PaymentContainer">
          <div className="paymentDetailsContainer">
            ...
            <p className="notice">
              Orders will only be processed once <strong>Proof of Payment</strong> & <strong>Attachment Info</strong> are
              send to Grabbler LLC.
            </p>
      ...
      <div className="navigation">
        <div className="returnContainer">
          ...
          <p className="returnText" onClick={() => onChange('InformationCheck')}>
            Return to Shipping
          </p>
        </div>
